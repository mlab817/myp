...
use App\Models\Scopes\PapScope;
...
class Pap extends Model
{
    ...
    public function other_vc_segments()
    {
        return $this->belongsToMany(ValueChainSegment::class, 'pap_vc_segment', 'pap_id', 'vc_segment_id','id','id');
    }
